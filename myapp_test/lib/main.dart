  ...
  Widget build(BuildContext context) {
    return new Container(
        ...
        child: new Row(children: <Widget>[
          ...
          new IconButton(icon: new Icon(Icons.search), tooltip: 'Search',
              onPressed: () {
            new SnackBar(
                content: new Text('This is snackbar test.'));
          }),
        ]));
  }
}
...
class MyScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Material(
      ...
      new Flexible(child: new Center(child: new Text('Hello, world!')))
    ]));
  }
}
